...
if __name__ == "__main__":
    ...
    for ep in range(epochs):
        ...
        for (batch, batch_slice_info) in iterate_minibatches_with_sliceinfo(images_tr, batch_size = batch_size, img_size_z = 64):
        ...
        if ep % validation_frequency == 0:
            ...
            batchcount = 0
            for (batch, batch_slice_info) in iterate_minibatches_with_sliceinfo(images_vl, batch_size = batch_size, img_size_z = 64):
                input_images = batch
